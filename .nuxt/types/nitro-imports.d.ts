declare global {
  ...
  const google: typeof import('../../server/utils/auth').google
  ...
  const lucia: typeof import('../../server/utils/auth').lucia
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/Volumes/APRIL_SSD/APRIL/fintrack/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from '/Volumes/APRIL_SSD/APRIL/fintrack/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { lucia, google } from '/Volumes/APRIL_SSD/APRIL/fintrack/server/utils/auth';
export { prisma } from '/Volumes/APRIL_SSD/APRIL/fintrack/server/utils/db';